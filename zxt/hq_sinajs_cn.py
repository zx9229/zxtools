...
def tmp_test(code_list):
    ...
    result_list = []
    fields_list = [
        ("合约简称", "开盘价", "昨收盘", "最新价", "最高价", "最低价", "买1价", "卖1价", "成交量", "成交额",
         "买1量", "买1价", "买2量", "买2价", "买3量", "买3价", "买4量", "买4价", "买5量", "买5价",
         "卖1量", "卖1价", "卖2量", "卖2价", "卖3量", "卖3价", "卖4量", "卖4价", "卖5量", "卖5价",
         "日期", "时间", "未知字段1", "未知字段2"),
        ("买1量", "买1价", "最新价", "卖1价", "卖1量", "持仓量", "未知字段1", "行权价", "昨结算",
         "开盘价", "涨停价", "跌停价", "卖5价", "卖5量", "卖4价", "卖4量", "卖3价", "卖3量", "卖2价",
        ...
        ("开盘价", "最高价", "最低价", "最新价", "成交量", "未知字段1", "持仓量", "未知字段2", "未知字段3",
         "涨停价", "跌停价", "未知字段4", "未知字段5", "昨收盘", "昨结算", "昨持仓", "买1价", "买1量",
         "买2价", "买2量", "买3价", "买3量", "买4价", "买4量", "买5价", "买5量", "卖1价", "卖1量",
         "卖2价", "卖2量", "卖3价", "卖3量", "卖4价", "卖4量", "卖5价", "卖5量", "日期", "时间",
         "未知字段6", "未知字段7", "未知字段8", "未知字段9", "未知字段10", "未知字段11", "未知字段12",
         "未知字段13", "未知字段14", "未知字段15", "未知字段16", "合约简称"),
        ("买1量", "买1价", "最新价", "卖1价", "卖1量", "持仓量", "涨跌幅", "行权价", "昨收盘", "开盘价",
         "涨停价", "跌停价", "卖5价", "卖5量", "卖4价", "卖4量", "卖3价", "卖3量", "卖2价", "卖2量",
